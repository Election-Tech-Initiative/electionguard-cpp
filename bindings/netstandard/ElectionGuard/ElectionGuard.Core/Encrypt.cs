...
namespace ElectionGuard
{
    ...
    ///
    /// </summary>
    public abstract class EncryptionDeviceBase : DisposableBase
    {
        ...
        public unsafe EncryptionDeviceBase(
            ulong deviceUuid,
            ulong sessionUuid,
            ulong launchCode,
            string location)
        ...
        public unsafe EncryptionDeviceBase(string json)
        {
...
#pragma warning restore CS1591 // Missing XML comment for publicly visible type or member
    ...
    /// </summary>
    public abstract class EncryptionMediatorBase : DisposableBase
    {
        ...
        public unsafe EncryptionMediatorBase(
            InternalManifest manifest,
            CiphertextElectionContext context,
            EncryptionDeviceBase device)
        {
