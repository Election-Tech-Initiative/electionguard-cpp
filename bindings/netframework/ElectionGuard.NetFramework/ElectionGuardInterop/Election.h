...
{
  public
    ref class CiphertextElectionContext : ManagedInstance<electionguard::CiphertextElectionContext>
    {
      public:
        ...
        CiphertextElectionContext(const uint64_t numberOfGuardians, const uint64_t quorum,
            ...
            : ManagedInstance(new electionguard::CiphertextElectionContext(
                numberOfGuardians, quorum,
                std::make_unique<electionguard::ElementModP>(*elGamalPublicKey->_instance),
                std::make_unique<electionguard::ElementModQ>(*commitmentHash->_instance),
                std::make_unique<electionguard::ElementModQ>(*manifestHash->_instance),
        ...
        internal : CiphertextElectionContext(
                     std::unique_ptr<electionguard::CiphertextElectionContext> other)
        {
      ...
      public:
        property uint64_t ^
          ...
          CommitmentHash {
              ElementModQ ^ get() {
                  auto unmanaged = this->_instance->getCommitmentHash();
          ...
          CryptoBaseHash {
              ElementModQ ^ get() {
                  auto unmanaged = this->_instance->getCryptoBaseHash();
                  return gcnew ElementModQ(unmanaged);
              }
          }
          ...
          CryptoExtendedBaseHash {
              ElementModQ ^ get() {
                  auto unmanaged = this->_instance->getCryptoExtendedBaseHash();
                  return gcnew ElementModQ(unmanaged);
              }
          }
