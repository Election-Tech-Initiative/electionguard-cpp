 ...
 * be easier to just test for defined(__SIZEOF_INT128__) only? */
     ...
     (defined(__powerpc64__) && defined(__LITTLE_ENDIAN__)) || defined(__s390x__) ||               \
     (defined(_MSC_VER) && defined(_M_X64) && defined(__clang__)) ||                               \
     (defined(__mips__) && defined(__LP64__)) || (defined(__riscv) && __riscv_xlen == 64) ||       \
...
#if !defined(KRML_VERIFIED_UINT128) && defined(IS_MSVC64)
#    include "karamel/fstar_uint128_msvc.h"
#elif !defined(KRML_VERIFIED_UINT128) && defined(HAS_INT128)
#    include "karamel/fstar_uint128_gcc64.h"
#else
#    include "karamel/FStar_UInt128_Verified.h"
#    include "karamel/fstar_uint128_struct_endianness.h"
#endif
